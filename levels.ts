...
// Length: ~3000px. Enemies: Base only. Goal: Introduce basic movement and capture.
const level1: LevelData = {
    ...
    platforms: [
        ...
        { x: 2200, y: GAME_HEIGHT - 350, width: 500, height: 30 },
    ],
    items: [
        ...
        { type: 'super-throw', x: 2600, y: GAME_HEIGHT - 110, width: 50, height: 50 },
        { type: 'joystick', x: 2750, y: GAME_HEIGHT - 110, width: 50, height: 50 },
    ],
    enemies: [
        { type: 'base', x: 400, y: GAME_HEIGHT - 290, width: 50, height: 50, originalX: 400, originalY: GAME_HEIGHT - 290 },
        { type: 'base', x: 1200, y: GAME_HEIGHT - 80, width: 50, height: 50, originalX: 1200, originalY: GAME_HEIGHT - 80 },
        { type: 'base', x: 1900, y: GAME_HEIGHT - 80, width: 50, height: 50, originalX: 1900, originalY: GAME_HEIGHT - 80 },
        { type: 'base', x: 1100, y: GAME_HEIGHT - 440, width: 50, height: 50, originalX: 1100, originalY: GAME_HEIGHT - 440 },
        { type: 'base', x: 2400, y: GAME_HEIGHT - 390, width: 50, height: 50, originalX: 2400, originalY: GAME_HEIGHT - 390 },
    ],
    goal: { x: 2900, y: GAME_HEIGHT - 40 - GOAL_HEIGHT, width: GOAL_WIDTH, height: GOAL_HEIGHT },
};

// --- LEVEL 2: Rising Up ---
// Length: ~3800px. Enemies: Base only. Goal: More complex platforming.
const level2: LevelData = {
    name: "Level 2: Rising Up",
    playerStart: { x: 100, y: GAME_HEIGHT - 120 },
    platforms: [
        { x: 0, y: GAME_HEIGHT - 40, width: 3800, height: 40 }, // Floor
        ...
        { x: 3100, y: GAME_HEIGHT - 200, width: 400, height: 30 },
    ],
    items: [
        ...
        { type: 'shield', x: 3400, y: GAME_HEIGHT - 270, width: 50, height: 50 },
        { type: 'floppy', x: 3250, y: GAME_HEIGHT - 110, width: 50, height: 50 },
    ],
    enemies: [
        { type: 'base', x: 600, y: GAME_HEIGHT - 80, width: 50, height: 50, originalX: 600, originalY: GAME_HEIGHT - 80 },
        ...
        { type: 'base', x: 3300, y: GAME_HEIGHT - 240, width: 50, height: 50, originalX: 3300, originalY: GAME_HEIGHT - 240 },
    ],
    goal: { x: 3700, y: GAME_HEIGHT - 40 - GOAL_HEIGHT, width: GOAL_WIDTH, height: GOAL_HEIGHT },
};

// --- LEVEL 3: Hoppy Hills ---
// Length: ~4500px. Enemies: Introduce Jumper. Goal: Teach player about the new threat.
...
const bossLevel1: LevelData = {
    ...
    boss: {
      x: (GAME_WIDTH / 2) - 160,
      y: GAME_HEIGHT / 2 - 200, // Corrected to start in the air
      width: 320,
      height: 320,
...
// Length: ~5200px. Enemies: Base, Jumper. Goal: Combine enemies, more verticality.
...
// --- BOSS 3 ---
const bossLevel3: LevelData = { ...bossLevel1, name: "BOSS: Final Frog"};

// --- LEVEL 12: The Factory ---
// Length: ~13500px. Enemies: All types. Goal: Complex mix of all challenges.
...
// A single, complex screen with no enemies, just a maze of platforms.
