...
export const levels: LevelData[] = [
  // Level 1: Introduction
  {
    ...
    platforms: [
      { x: 0, y: GAME_HEIGHT - 40, width: GAME_WIDTH, height: 40 }, // Floor
      { x: 300, y: GAME_HEIGHT - 250, width: 400, height: 30 },
      { x: GAME_WIDTH - 700, y: GAME_HEIGHT - 250, width: 400, height: 30 },
      { x: 650, y: GAME_HEIGHT - 500, width: 600, height: 30 },
      { x: 150, y: GAME_HEIGHT - 750, width: 300, height: 30 },
    ...
    items: [
      ...
      { type: 'cartridge', x: GAME_WIDTH / 2, y: GAME_HEIGHT - 570, width: 50, height: 50 },
      { type: 'joystick', x: 200, y: GAME_HEIGHT - 820, width: 50, height: 50 },
      { type: 'floppy', x: GAME_WIDTH - 300, y: GAME_HEIGHT - 820, width: 50, height: 50 },
      { type: 'shield', x: 925, y: GAME_HEIGHT - 570, width: 50, height: 50 },
    ],
    enemies: [
  ...
  // Level 2: Introduction to Jumpers
  {
    playerStart: { x: 100, y: GAME_HEIGHT - 120 },
    platforms: [
      { x: 0, y: GAME_HEIGHT - 40, width: 600, height: 40 },
      { x: 750, y: GAME_HEIGHT - 40, width: 600, height: 40 },
      { x: 1500, y: GAME_HEIGHT - 40, width: 420, height: 40 },
  ...
  // Level 5: Final Fortress
  {
    ...
    platforms: [
        ...
        { x: 1450, y: GAME_HEIGHT - 40, width: 470, height: 40 },
  ...
  // Level 9: Chaos Castle
  {
    ...
    platforms: [
        ...
        { x: 0, y: GAME_HEIGHT - 40, width: 600, height: 40 },
        { x: GAME_WIDTH - 600, y: GAME_HEIGHT - 40, width: 600, height: 40 },
